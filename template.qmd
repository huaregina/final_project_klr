...
df_ccao = pd.read_csv('./data_ccao.csv')
df_coc = pd.read_csv('./df_city_owned.csv')
```
...
railLine_data = gpd.read_file('CTA _RailLines\geo_export.shp')
color_mapping = {
    "ML": "gray",
    "BL": "blue",
    "BR": "brown",
...
df_pop = pd.read_csv('./Chicago_Population_Counts.csv')
...
alt.Chart(df_pop_pct_top5).mark_bar().encode(
    ...
    width=600,
    height=400,
    title='Racial Composition of Top 5 Zip Codes with most vacant lands'
)
```
